    ...
    public partial class Courses_Form : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.Rows.Count > 0)
            {
                ...
                newDataRow.Cells[1].Value = txtCost.Text;
                newDataRow.Cells[2].Value = txtDriver.Text;
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtCost.Text = selectedRow.Cells[1].Value.ToString();
            txtDriver.Text = selectedRow.Cells[2].Value.ToString();
